      ...
      <section class="text-gray-600 body-font relative my-12">
        ...
        <div class="container px-5 py-24 mx-auto flex">
          <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            <h2 class="text-red-500 text-lg mb-2 font-medium title-font">Kontakt os i dag</h2>
            ...
            <p class="leading-relaxed my-5 text-gray-600">Ring eller skriv til os for et uforpligtende tilbud.</p>

            <div class="flex flex-col space-y-2 relative mb-4">
              <a href="tel:+4526301436" class="text-white w-full underline text-center bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg">
              ...
              <a href="mailto:pe@cars2lease.dk" class="text-white w-full text-center bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg">
                <span className='flex flex-row items-center justify-center space-x-3'>
                  <IoMdMail size={16}/>
